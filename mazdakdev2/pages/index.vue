          ...
          <header>          
            ...
            <section>
                ...
                <div id="cv" class="flex mt-6 flex-row items-center justify-center md:ml-14 md:space-x-52 space-x-10 ">
                    ...
                    <a href="https://raw.githubusercontent.com/mazdakdev/mazdakdev.github.io/main/Mazdak-Pakghideh-EN-CV.pdf"   class="cv md:ml-30  h-[56px]  flex flex-col md:flex-row hover:scale-[1.05] items-center justify-center p-7 ">
